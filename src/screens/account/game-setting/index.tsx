...
export const GameSettingScreen = () => {
  ...
  const [teamXoaySettings, setTeamXoaySettings] = useState<{
    ...
    holeCount: 3, comparison: 'best', byMonth: false, playBest: true, restrictions: false,
  });
            ...
            {settingSections.map((section) => {
              ...
              return (
                ...
                >
                  ...
                  <SelectionCard
                    isChecked={isActive}
                    onPress={() => setSelectedSection(isActive ? null : section.id)}
                    style={[
                      isActive && styles.settingCardHeaderActive
                    ]}
                  >
                    <View style={styles.cardContent}>
                      ...
                      {section.memberCount > 0 && (
                        <View style={styles.badge}>
                          <Text style={styles.badgeText}>{section.memberCount}</Text>
                          <Ionicons name="people" size={12} color={Colors.white} style={{ marginLeft: 4 }} />
                        </View>
                      )}
                    </View>
                  </SelectionCard>
...
const styles = StyleSheet.create({
  ...
  placeholderSection: { paddingHorizontal: 16, paddingVertical: 20, alignItems: 'center' },
